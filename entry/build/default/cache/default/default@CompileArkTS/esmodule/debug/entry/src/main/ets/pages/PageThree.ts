...
interface pageThreeTmp_Params {
    pageInfos?: NavPathStack;
}
export class pageThreeTmp extends ViewPU {
    ...
    setInitiallyProvidedValue(params: pageThreeTmp_Params) {
    }
    updateStateVars(params: pageThreeTmp_Params) {
    }
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create("NavDestinationContent3");
                }, Text);
                Text.pop();
                Column.pop();
            }, { moduleName: "entry", pagePath: "entry/src/main/ets/pages/PageThree" });
            NavDestination.title("NavDestinationTitle3");
